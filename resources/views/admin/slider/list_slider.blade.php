              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $slide->slider_name }}</td>
                   <td><img src="public/upload/slider/{{ $slide->slider_image }}" alt="" height="130" width="400"></td>
                  ...
                  <td>
                      ...
                      <a onclick="return confirm('Bạn chắc chắn muốn xóa mục này?')" href="{{URL::to ('/delete-slide/'.$slide->slider_id) }}" class="active styling-edit" ui-toggle-class="">
